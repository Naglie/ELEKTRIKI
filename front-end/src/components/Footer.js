        ...
        return (
          <footer className='footer mt-auto pt-3'>
            <Container className="justify-content-center">
                ...
                <div className="d-flex">
                    ...
                    <div>
                        ...
                        <span>Õppesekretär Narva: +372 356 9343, +372 510 8560</span>
                        <span>Täiendusõppe kursused: +372 5688 0405, +372 526 1318</span>                        
                    </div>
                </div>
            </Container>
            <Container className="text-center" fluid>
                ...
                <div>
                    <p>Copyright 2023 © Ida-Virumaa Kutsehariduskeskus. Daniil Vassiljev, Daniil Divissenko, Jegor Golub</p>
                </div>
            </Container>
          </footer>
        )
